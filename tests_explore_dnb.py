...
def test_filtre_session():
    assert dnb.filtre_session(liste4, 2020) == [(2020, 'ALBERT SIDOISNE', 28, 134, 118),(2020, 'MATHURIN REGNIER', 28, 152, 118)]
    assert dnb.filtre_session(liste4, 2018) == []
    
    
def test_filtre_departement():
    assert dnb.filtre_departement(liste1, 45) == []
    assert dnb.filtre_departement(liste4, 28) == [(2012, "ALBERT SIDOISNE", 28, 98, 78),(2020, 'ALBERT SIDOISNE', 28, 134, 118),(2020, 'MATHURIN REGNIER', 28, 152, 118)]


def test_filtre_college():
    assert dnb.filtre_college(liste1, 'EMILE', 45) == []
    assert dnb.filtre_college(liste1, 'NERMONT', 28) == [(2020, 'DE NERMONT - CHATEAUDUN', 28, 74, 60),(2020, 'DE NERMONT - NOGENT', 28, 28, 27)]
...
def test_moyenne_taux_reussite_college():
    assert dnb.moyenne_taux_reussite_college(liste1, 'ALBERT SIDOISNE', 28) == 118/134*100
    assert dnb.moyenne_taux_reussite_college(liste2, 'GILBERT COURTOIS', 28) == (18/22*100+15/24*100)/2
